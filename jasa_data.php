...
<table width="700" border="0" cellspacing="1" cellpadding="3">
  ...
  <tr>
    <td colspan="2"><a href="?page=Add-Jasa"><img src="images/btn_add_data2.png" width="100" height="25"></a></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2"><table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <th width="7%" align="center" scope="col">Kode</th>
        <th width="47%" scope="col">Nama Jasa</th>
        <th width="17%" align="right" scope="col">Harga</th>
        <th width="17%" align="right" scope="col">Diskon %</th>
        <th width="17%" align="right" scope="col">ppn %</th>
	...
	$jasaSql = "SELECT * FROM jasa j, bahanbaku b where j.kd_bahan = b.kd_bahan ORDER BY (SUBSTR(kd_jasa,3) + 0) ASC LIMIT $hal, $row";
	...
	?>
      <tr>
        ...
        <td align="right"><?php echo format_angka($jasaRow['harga_jasa'] + $jasaRow['harga_bahan']); ?></td>
        <td align="right"><?php echo $jasaRow['diskon']; ?></td>
        <td align="right"><?php echo $jasaRow['ppn']; ?></td>
